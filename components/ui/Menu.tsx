...
export default function MenuPage() {
  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-[#0a0a0a] font-sans text-[#f5f2ec] selection:bg-[#c65a24] selection:text-white">
      ...
      <section className="relative overflow-hidden border-t border-white/[0.09] bg-[#17110d] px-5 py-16 text-center sm:px-8 sm:py-20 lg:px-12"><div className="absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#c65a24]/20 blur-[100px]" aria-hidden="true" /><div className="relative mx-auto max-w-2xl"><p className="text-xs font-bold uppercase tracking-[0.24em] text-[#e67838]">Karachi Flames</p><h2 className="mt-4 font-serif text-4xl tracking-[-0.03em] sm:text-5xl">Come taste the flame.</h2><p className="mx-auto mt-4 max-w-xl leading-7 text-[#d8d3ca]/78">Authentic Karachi flavor, made fresh and served with pride.</p><div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row"><Link href="/locations" className="inline-flex min-h-12 items-center justify-center rounded-full bg-[#c65a24] px-6 text-sm font-bold text-white transition hover:bg-[#dc6c2e] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f5f2ec]">Order Now</Link><Link href="/locations" className="inline-flex min-h-12 items-center justify-center rounded-full border border-white/20 px-6 text-sm font-bold text-[#f5f2ec] transition hover:border-[#e67838] hover:text-[#e67838] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#f5f2ec]">Find a Location</Link></div></div></section>
