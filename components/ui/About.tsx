  ...
  return (
    <main id="page-top" className="min-h-screen overflow-x-clip bg-[#080808] font-sans text-[#F5F1E8] selection:bg-[#C65A24] selection:text-white">
      ...
      <section aria-labelledby="taste-heading" className="relative isolate overflow-hidden bg-[#080808] px-5 py-24 sm:px-8 sm:py-32 lg:px-12 lg:py-44">
        ...
        <div className="relative mx-auto max-w-4xl text-center"><p className="font-mono text-[10px] uppercase tracking-[0.24em] text-[#D76A2C]">The next chapter</p><h2 id="taste-heading" className="mt-7 font-serif text-6xl leading-[.86] tracking-[-0.065em] sm:text-7xl lg:text-9xl">Taste the<br /><em className="font-normal text-[#D76A2C]">story.</em></h2><p className="mx-auto mt-8 max-w-xl text-base leading-8 text-white/75 sm:text-lg">The best way to understand Karachi Flames is to taste it.</p><div className="mx-auto mt-10 flex max-w-md flex-col gap-3 sm:flex-row sm:justify-center"><Link className="inline-flex min-h-12 items-center justify-center bg-[#C65A24] px-6 text-xs font-semibold uppercase tracking-[0.15em] transition hover:bg-[#D76A2C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white" href="/menu">Explore the menu</Link><Link className="inline-flex min-h-12 items-center justify-center border border-white/30 px-6 text-xs font-semibold uppercase tracking-[0.15em] transition hover:border-[#D76A2C] hover:text-[#D76A2C] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#D76A2C]" href="/locations">Find a location</Link></div></div>
      </section>
